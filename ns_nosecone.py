...
logger.info('Done. Mask function phi constructed and plotted at {}'.format(run_name + '/phi.png'))
rx, ry = zip(*rs)
dist.comm.Barrier()
#################################################################
...
if dist.comm.rank == 0:
    ...
    logger.info('final flow state plotted to {}'.format(run_name + '/flow_final.png'))